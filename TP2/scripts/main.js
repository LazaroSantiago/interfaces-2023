...
function start(){
    ...
    switch (mode) {  //genera las fichas en base al modo de juego
        case 6:
            columns=9;
            rows=8;
            piecesGamer(1,765,45,token1,20); // cargo en un arreglo las fichas del jugador 1
            piecesGamer(2,765,1280,token2,20); // cargo en un arreglo las fichas del jugador 2
            break;
    
        case 5:
            columns=8;
            rows=7;
            piecesGamer(1,685,45,token1,20);
            piecesGamer(2,685,1280,token2,20); 
            break;
        default:
            columns=7;
            rows=6;
            piecesGamer(1,605,45,token1,20);
            piecesGamer(2,605,600,token2,20);   
        break;
    }
